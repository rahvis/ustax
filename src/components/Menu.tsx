...
import W7Component from '../component/w7/W7Component'
import W7COAComponent from '../component/w7coa/W7COAComponent'
...
export const drawerSections: Section[] = [
  ...
  },
  {
    title: 'Income',
    items: [
      item('Wages (W7)', Urls.income.w7s, <W7Component />),
      item('Wages (W7COA)', Urls.income.w2COAs, <W7COAComponent />),
